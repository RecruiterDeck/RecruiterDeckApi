...
$(function () {
    ...
    var lsKey = 'RecruiterDeckAPI_accessToken';
    ...
    function setAccessToken(e) {
        ...
        if (key && key.trim() !== '') {
            ...
            accessToken = key;
            $('.accessTokenDisplay').text('Logged In').addClass('set');
            ...
            $('.accessTokenDisplay').text('Please Log In').removeClass('set');
    ...
    function onInputChange(e) {
        ...
        if (accessToken !== key) {
            ...
            $('.accessTokenDisplay').text('Logged In');
        }
    }
